package com.dougnoel.sentinel.actions;
...
public class ActionFactory {
     ...
     */
	public static Object createAction(String actionName, API api) {
    ...
    private static Map<String, String> findActionData(String actionName, String apiName) {
		Map<String, String> elementData = Configuration.getAction(actionName, apiName);
		if (elementData == null) {
