package sentinel.steps;

import static org.junit.Assert.assertTrue;
import static sentinel.utils.ElementFunctions.*;
...
public class BaseSteps {
     ...
     * </ul>
     * @see sentinel.utils.ConfigurationManager#getUsername()
     * @see sentinel.utils.ConfigurationManager#getPassword()
     * @see sentinel.utils.ConfigurationManager#getUsername(String)
     * @see sentinel.utils.ConfigurationManager#getPassword(String)
     ...
     * </ul>
     * @see sentinel.utils.ConfigurationManager#getTestData(String, String)
     ...
     * </ul>
     * @see sentinel.pages.PageManager#navigateBack()
     * @see sentinel.pages.PageManager#navigateForward()
     * @see sentinel.pages.PageManager#refresh()
